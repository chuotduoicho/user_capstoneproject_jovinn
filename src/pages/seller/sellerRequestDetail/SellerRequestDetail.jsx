    ...
    <div className="buyer_profile">
      ...
      <Container maxWidth="lg" className="profession_form">
        ...
        <div
          ...
          style={{ border: "2px solid rgb(238, 225, 225)" }}
        >
          Đưa ra đề nghị cho yêu cầu này!
          <Link to="/sellerHome/createOffer">
            <Button
              variant="outlined"
              color="primary"
              style={{ marginLeft: "20px" }}
        ...
        <div
          ...
          style={{ border: "2px solid rgb(238, 225, 225)" }}
        >
          Bạn đã đưa ra đề nghị cho yêu cầu này!
          <Link to="/sellerHome/offerDetail/abc">
            <Button
              variant="outlined"
              color="primary"
              style={{ marginLeft: "20px" }}
            >
              Chỉnh sửa đề nghị
            </Button>{" "}
          </Link>
        </div>
      </Container>
